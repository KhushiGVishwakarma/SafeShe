...
import com.example.safeshe.databinding.FragmentHomeBinding;
import com.example.safeshe.service.SosService;
import com.example.safeshe.ui.activity.LoginRegisterActivity;
import com.example.safeshe.ui.activity.MainActivity;
import com.example.safeshe.util.AppUtil;
...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        binding.reportIncident.setOnClickListener(v -> Navigation.findNavController(view).navigate(R.id.action_homeFragment_to_reportIncidentFragment));
        binding.incidentHistory.setOnClickListener(v -> Navigation.findNavController(view).navigate(R.id.action_homeFragment_to_incidentHistoryFragment));
        binding.chatbot.setOnClickListener(v -> Navigation.findNavController(view).navigate(R.id.action_homeFragment_to_chatbotFragment));
        binding.feedback.setOnClickListener(v -> Navigation.findNavController(view).navigate(R.id.action_homeFragment_to_feedbackFragment));
