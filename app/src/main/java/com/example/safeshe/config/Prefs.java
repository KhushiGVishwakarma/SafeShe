package com.example.safeshe.config;
...
public class Prefs {
    ...
    public static SharedPreferences prefs = SafeShe.getAppContext().getSharedPreferences(BuildConfig.APPLICATION_ID, Context.MODE_PRIVATE);
