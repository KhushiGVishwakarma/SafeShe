package com.example.safeshe.util;
...
import com.example.safeshe.api.MyFirebaseAuth;
import com.example.safeshe.api.NotificationAPI;
import com.example.safeshe.common.Constants;
import com.example.safeshe.model.NotificationDataModel;
import com.example.safeshe.model.NotificationSenderModel;
import com.example.safeshe.model.NotificationTokenModel;
...
public class FirebaseUtil {
    ...
    public static class SendNotificationTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... voids) {
            try {
                return MyFirebaseAuth.getAccessToken(SafeShe.getAppContext());
            } catch (IOException e) {
