package com.example.safeshe.common;
...
public class Constants {
    ...
    public static final String SETTINGS_SEND_NEARBY_ALERTS = "send_emergency_sms";
    ...
    public static final String SETTINGS_SEND_EMERGENCY_SMS = "send_emergency_sms";
